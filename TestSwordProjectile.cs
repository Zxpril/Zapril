...
namespace ZaprilMod.Projectiles
{
	public class TestSwordProjectile : ModProjectile
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("TestSwordProjectile");     //The English name of the projectile
		...
		public override void SetDefaults() {
			...
			projectile.penetrate = 15;           //How many monsters the projectile can penetrate. (OnTileCollide below also decrements penetrate for bounces as well)
